...
from .core.session import ZE, tgbot
...
__author__ = "سورس زد إي <https://github.com/Source-Ze/ZE0>"
__copyright__ = f" حقوق سورس زد إي (C) 2023 - 2024  {__author__}"

ZE.version = __version__
ZE.tgbot.version = __version__
