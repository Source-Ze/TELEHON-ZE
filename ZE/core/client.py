        ...
        **kwargs,
        ...
        def decorator(func):  # sourcery no-metrics
            async def wrapper(check):  # sourcery no-metrics
                ...
                if hasattr(chat, "title"):
                    if (
                        ...
                        await check.client.send_message(
                            "@UP_UO", "اهلا مودي استخدامي ما يناسب زد إي"
                        )
                        return
                ...
                try:
                    ...
                    if not disable_errors:
                        ...
                        link = "[هنا](https://t.me/UI_OS)"
                        text = "**تقرير خطأ سورس زد إي**\n\n" + "اذا اردت يمكنك التبليغ"
            ...
            if pattern is not None:
                ...
                if edited:
                    ZE.add_event_handler(func, events.MessageEdited(**kwargs))
                ZE.add_event_handler(func, events.NewMessage(**kwargs))
            return wrapper
    ...
    def bot_cmd(
        ...
        **kwargs,
        ...
        def decorator(func):
            ...
            if edited is True:
                ZE.tgbot.add_event_handler(func, events.MessageEdited(**kwargs))
            else:
                ZE.tgbot.add_event_handler(func, events.NewMessage(**kwargs))
