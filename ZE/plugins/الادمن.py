...
async def _ban_person(event):
    ...
    if user.id == 5650717789:
        return await edit_delete(event, "**- لا يمكنك حظر مطور السورس مودي****")
...
@ZE.ar_cmd(pattern="الغاء كتم(?:\s|$)([\s\S]*)")
...
@ZE.ar_cmd(pattern="الغاء تثبيت( الكل|$)")
