...
@ZE.ar_cmd(pattern="م15")
async def hi(event):
    await edit_or_reply(
        event,
        "⩹♤■■■■ 《 𝑺𝑶𝑼𝑹𝑪𝑬 𝒁𝑬 》 ■■■■♤\n\nاوامر جلب الذاتية وامر الاضافة**:\n\n ◂  `.ضيف`\n❃ اكتب الامر مع رابط مجموعه التي تريد سحب اعضائها وارسل الامر في مجموعتك لسحبهم الى مجموعتك\n\n ◂ `.ذاتيه` او `.ذاتية`\n❃ بالرد على صورة او فيديو ذاتية التدمير لحفظها وارسالها في الرسائل المحفوظة بسرية تامة الامر ل زد إي حصريا!\n⩹♤■■■■ 《 𝑺𝑶𝑼𝑹𝑪𝑬 𝒁𝑬 》 ■■■■♤",
    )


@ZE.ar_cmd(pattern="م16")
async def hi(event):
    await edit_or_reply(
        event,
