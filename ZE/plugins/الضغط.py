...
from . import edit_delete, edit_or_reply, ZE, progress
...
@ZE.ar_cmd(pattern="ان زايب(?:\s|$)([\s\S]*)")
async def zip_file(event):
...
@ZE.ar_cmd(pattern="ان تار(?:\s|$)([\s\S]*)")
