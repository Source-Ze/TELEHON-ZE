...
@ZE.on(admin_cmd(pattern="(تجميع العرب|تجميع عرب)"))
async def _(event):
    if tepthon[0] == "yes":
        ...
        await ZE.send_message('@xnsex21bot', '/start')
        await asyncio.sleep(5)
        msg0 = await ZE.get_messages('@xnsex21bot', limit=1)
        await msg0[0].click(2)
        await asyncio.sleep(5)
        msg1 = await ZE.get_messages('@xnsex21bot', limit=1)
        ...
        for i in range(100):
            ...
            try:
                ...
                msg2 = await ZE.get_messages('@xnsex21bot', limit=1)
