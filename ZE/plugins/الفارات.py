...
async def variable(var):
    ...
    if exe == "توقيت":
        ...
        if variable in heroku_var:
            await edit_or_reply(
                var,
                "**⌔∮ تم بنجاح تغيير الوقت الخاص بك\n\n❃ جار اعادة تشغيل سورس زد إي انتظر من 2-5 دقائق ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
    ...
    if exe == "الصورة" or exe == "الصوره":
        ...
        if gvarstatus("DIGITAL_PIC") is None:
            await edit_or_reply(
                var,
                "**⌔∮ تم بنجاح تغيير فار صورة الحساب\n\n❃ جار اعادة تشغيل سورس زد إي انتظر دقيقة ليتشغل مره اخرى**",
            )
        else:
            await edit_or_reply(
                var,
