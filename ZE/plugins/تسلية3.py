...
from . import edit_delete, edit_or_reply, ZE, mention
...
async def _(event):
    ...
    animation_chars = [
        ...
        "**Starting process with command** `python3 -m ZE`",
        "**State changed from starting to up**",
        "__INFO:ZE:Logged in as 557667062__",
        "__INFO:ZE:Successfully loaded all plugins__",
        "**Build Succeeded**",
    ]
...
@ZE.on(admin_cmd(pattern="احبك"))
async def rz(ZE):
    roz = random.choice(love)
    return await edit_or_reply(ZE, roz)
