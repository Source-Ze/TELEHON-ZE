...
@ZE.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}ترامب <text>",
        "examples": "{tr}trump  is One of the Popular ZE",
    },
)
...
@ZE.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}غير عقلي CatZE is One of the Popular ZE",
    },
)
async def nekobot(cat):
    text = cat.pattern_match.group(1)
...
@ZE.ar_cmd(
    ...
    info={
        ...
        "usage": "{tr}كانا text",
        "examples": "{tr}kanna  is One of the Popular ZE",
    },
)
async def nekobot(cat):
...
@ZE.ar_cmd(
    ...
    info={
        ...
        "examples": "{tr}tweet iamsrk ; is One of the Popular ZE",
    },
)
async def nekobot(cat):
