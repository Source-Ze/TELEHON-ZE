...
class Config(object):
    ...
    # كود تيرمكس باستخدام امر python3 stringsetup.py او من بوت @ZEBXBOT
    ...
    # رابط الريبو
    UPSTREAM_REPO = os.environ.get("UPSTREAM_REPO", "https://github.com/Source-Ze/UP_UO5")
    # ملفات خارجيه اضافيه
    EXTERNAL_REPO = os.environ.get("EXTERNAL_REPO", None)
    if bool(EXTERNAL_REPO and (EXTERNAL_REPO.lower() != "false")):
        if not url(EXTERNAL_REPO):
            EXTERNAL_REPO = "https://github.com/Source-Ze/zPlugins"
    else:
        EXTERNAL_REPO = None
    # فارات الميوزك
